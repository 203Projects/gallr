...
const englishMessages = {
  ...
  exhibitions: {
    ...
    errors: {
      ...
      withdraw: "Submission could not be withdrawn. Try again.",
      discard: "Draft could not be discarded. Try again.",
      alreadyDecided: "Staff has already approved or published this exhibition. Reload to see its latest status.",
      addressSearch: "Address search failed.",
    ...
    editor: {
      ...
      review: "Review",
      inReview: "Your listing is in staff review. Withdraw it to make changes, then submit again when ready.",
      withdraw: "Withdraw to edit",
    ...
    dashboard: {
      ...
      discardAria: (name: string) => `Discard ${name}`,
      discardTitle: "Discard draft?",
      discardBody: "Any pending submission will be withdrawn from staff review, and this draft will be removed from your exhibitions. Review history will be retained. Cancel to keep the draft.",
...
const koreanMessages = {
  ...
  exhibitions: {
    ...
    errors: {
      ...
      withdraw: "제출을 철회하지 못했습니다. 다시 시도하세요.",
      discard: "초안을 폐기하지 못했습니다. 다시 시도하세요.",
      alreadyDecided: "스태프가 이미 승인하거나 게시한 전시입니다. 새로고침하여 최신 상태를 확인하세요.",
    ...
    editor: {
      ...
      review: "검토", inReview: "스태프가 전시를 검토하고 있습니다. 제출을 철회하면 수정 후 다시 제출할 수 있습니다.", withdraw: "제출 철회 후 수정", withdrawing: "철회 중…", viewPublic: "공개 페이지 보기", publicPageDelay: "공개 페이지는 승인 후 다시 생성되며 몇 분 안에 공개됩니다.",
    ...
    dashboard: {
      ...
      discard: "초안 폐기", discardAria: (name: string) => `${name} 폐기`, discardTitle: "초안을 폐기할까요?",
      discardBody: "검토 중인 제출이 있다면 철회하고 내 전시에서 초안을 제거합니다. 검토 이력은 보관됩니다. 초안을 유지하려면 취소하세요.",
