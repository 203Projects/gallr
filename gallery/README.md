...
`VITE_LAUNCH_KIT_ENABLED=false` until the free Launch Kit capability is
separately approved. No payment provider is connected. Keep the independent R4 owner-management capability
