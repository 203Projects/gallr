...
class EventRepositoryTest {
    ...
    @Test
    fun `getActiveEvents includes event whose date range covers today`() =
        runTest {
    ...
    @Test
    fun `getActiveEvents excludes event whose end_date is before today`() =
        runTest {
    ...
    @Test
    fun `getActiveEvents includes upcoming event whose start_date is after today`() =
        runTest {
    ...
    @Test
    fun `getActiveEvents excludes event with isActive false even when in date range`() =
        runTest {
    ...
    @Test
    fun `getActiveEvents sorts by start_date ascending`() =
        runTest {
    ...
    @Test
    fun `getEventById returns null when event missing`() =
        runTest {
    ...
    @Test
    fun `getEventById returns the event when present`() =
        runTest {
    ...
    @Test
    fun `getExhibitionsForEvent returns the exhibitions for the event id`() =
        runTest {
            val e = event("a", LocalDate(2025, 4, 18), LocalDate(2025, 5, 10))
