...
class LanguageRepositoryTest {
    @Test
    fun `observeLanguage returns Korean when no preference is saved`() =
        runTest {
    ...
    @Test
    fun `observeLanguage returns English when English preference is saved`() =
        runTest {
    ...
    @Test
    fun `observeLanguage returns Korean when Korean preference is saved`() =
        runTest {
    ...
    @Test
    fun `setLanguage persists and is observable`() =
        runTest {
            val repo = FakeLanguageRepository(savedLanguage = null)
