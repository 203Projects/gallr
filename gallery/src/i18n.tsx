...
const englishMessages = {
  ...
  exhibitions: {
    ...
    errors: {
      ...
      checkout: "Launch Kit checkout could not be started.",
  ...
  launch: {
    ...
    paymentBody: "We’ll activate the Launch Kit after Stripe confirms payment.",
...
const koreanMessages = {
  ...
  exhibitions: {
    ...
    errors: {
      ...
      checkout: "런치 키트 결제를 시작하지 못했습니다.", load: "전시를 불러오지 못했습니다.", create: "초안을 만들지 못했습니다.",
    },
    editor: {
      ...
      review: "검토", inReview: "전시 목록을 스태프가 검토하고 있습니다.", viewPublic: "공개 페이지 보기", publicImpact: "공개 페이지 조회",
      openingCheckout: "결제 여는 중…", launch: "이 전시 런치하기", launchSoon: "런치 키트는 곧 제공됩니다. 게시된 전시 목록은 이미 공개되었습니다.",
  ...
  launch: {
    ...
    paymentPending: "결제 확인 중", paymentBody: "Stripe에서 결제를 확인하면 런치 키트가 활성화됩니다.", openingNight: "오프닝", viewRsvp: "RSVP 페이지 보기",
    ...
    name: "이름", email: "이메일", party: "참석 인원", saveGuest: "게스트 저장", searchGuests: "게스트 검색", all: "전체",
