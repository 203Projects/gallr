...
class CachedExhibitionRepositoryTest {
    ...
    @Test
    fun successful_full_catalogue_is_persisted() =
    ...
    @Test
    fun cache_write_failure_does_not_hide_fresh_remote_catalogue() =
        kotlinx.coroutines.test.runTest {
            val exhibitions = listOf(exhibition("remote", isFeatured = true))
            val repository =
                CachedExhibitionRepository(
    ...
    @Test
    fun successful_featured_response_does_not_replace_complete_cache() =
        kotlinx.coroutines.test.runTest {
    ...
    @Test
    fun cached_catalogue_is_returned_when_remote_load_fails() =
        kotlinx.coroutines.test.runTest {
    ...
    @Test
    fun featured_fallback_is_derived_from_verified_full_catalogue_cache() =
        kotlinx.coroutines.test.runTest {
    ...
    @Test
    fun cache_read_failure_preserves_original_remote_failure() =
        kotlinx.coroutines.test.runTest {
