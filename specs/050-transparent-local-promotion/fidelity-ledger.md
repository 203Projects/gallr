...
2. **Disclosure:** `Promoted near you`, `Promoted placement`, the once-per-day limit, and the expandable `Why am I seeing this?` explanation remain visible at both sizes.
3. **Canonical content:** The promotion CTA resolves its exhibition ID to the existing public detail URL; it does not create a promotional detail route or duplicate catalogue record.
